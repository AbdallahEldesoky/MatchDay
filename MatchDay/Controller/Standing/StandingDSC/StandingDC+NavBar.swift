...
extension StandingDatasourceController {
    ...
    func setupNavBarItem(){
        ...
        let leagueLabel = Default.setupLabel(text: leagueNavItem, textAlignment: .center, fontSize: 16, type: .bold)
